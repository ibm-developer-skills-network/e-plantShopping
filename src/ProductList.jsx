...
function ProductList() {
   ...
   const handleAddToCart = (plant) => {
    const product = {
        ...plant,
        cost: parseFloat(plant.cost.replace('$', ''))  // Convert string cost to number
    };
...
return (
    ...
    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
        <h1 className='cart' style={{ position: 'relative', display: 'inline-block', width: '68px', height: '68px' }}>
            ...
            <span style={{ position: 'absolute', top: '0', right: '0', background: 'red', color: 'white', borderRadius: '50%', padding: '2px 6px', fontSize: '12px', lineHeight: '14px' }}>
                {totalQuantity}
            </span>
        </h1>
    </a>
                        ...
                        <div className="product-list">
                            {category.plants.map((plant, plantIndex) => (
                                <div className="product-card" key={plantIndex}>
                                    ...
                                    <div className='cost' style={{ color: 'red' }}>{plant.cost}</div>
