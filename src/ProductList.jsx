...
function ProductList(props) {
    ...
    const dynamicStyle = {
        marginLeft: total > 9 ? "18px" : "26px" // Adjust margin by -10px for double digits
      };
        ...
        <div className="product-grid">
            ...
            {item.plants.map((plant)=>
                <div className='product-card'>
                    ...
                    <p>{plant.cost}</p>
                    <button 
  style={{backgroundColor: alreadyInCart(plant.name) ? "gray" : "#e74c3c"}} 
