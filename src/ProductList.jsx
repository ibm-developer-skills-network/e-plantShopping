...
const handleAddToCart = (plant) => {
    ...
    onCartUpdate(prevCount => prevCount + 1);
  };
...
return (
    ...
    <div>
      <div className="navbar" style={styleObj}>
        ...
        <div>
      <CartCounter count={cartCount} /> {/* Mostrar el contador */}
  ...
  <div>
    <a href="#" onClick={handleCartClick} style={styleA}>
      ...
      {showCart && <CartItem />} {/* This will show the CartItem component when the cart is clicked */}
    </div>
  ;
}
