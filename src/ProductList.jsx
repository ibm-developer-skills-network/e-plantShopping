...
function ProductList({ cartCount, setCartCount }) {
  ...
  const styleObj = {
    backgroundColor: "#333232", // Change this to match your CSS
    color: "#fff!important",
    padding: "15px",
    display: "flex",
  ...
  const handlePlantsClick = (e) => {
    e.preventDefault();
    console.log("Plants clicked, setting showPlants to true");
    setShowPlants(true);
    setShowCart(false);
  };
      ...
      <div className="navbar" style={styleObj}>
        <div className="tag">
          <div className="luxury">
            <img
              src="https://static.vecteezy.com/system/resources/thumbnails/049/855/274/small_2x/nature-background-high-resolution-wallpaper-for-a-serene-and-stunning-view-photo.jpg"
              alt=""
            />
            <a href="/" style={{ textDecoration: "none" }}>
              <div>
                <h3 style={{ color: "white" }}>Dishaz Place</h3>
                <i style={{ color: "white" }}>All Green Here</i>
              </div>
            </a>
          </div>
        </div>
          ...
          <div className="category-list">
            {plantsArray.map((category, index) => (
              <div key={index} className="category-card">
                ...
                <p>Number of plants: {category.plants.length}</p>
                <button
                  onClick={handleReturnToMain}
                  className="view-plants-btn"
                >
                  View Plants
                </button>
              </div>
