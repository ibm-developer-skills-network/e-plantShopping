...
const handlePlantsClick = (e) => {
  ...
  const handleAddToCart = (product) => {
    ...
    setAddedToCart((prevState) => ({
       ...prevState,
       [product.name]: true, // Set the product name as key and value as true to indicate it's added to cart key:value
     }));
  };
            ...
            <div style={styleObjUl}>
                ...
                <h1 className='cart' style={{ position: 'relative' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="68" width="68">
                        ...
                        {totalQuantity > 0 && (
                            <text x="50%" y="50%" textAnchor="middle" stroke="#000" strokeWidth="1px" dy=".3em" fontSize="80" fill="#fff">
                                {totalQuantity}
                            </text>
                        )}
                    </svg>
