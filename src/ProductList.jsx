...
function ProductList() {
    ...
    const handleContinueShopping = () => {
        setShowCart(false); // Switch to showing the plant listing page
      };

    // Calculate total quantity from the cart items in the Redux store
    const totalQuantity = cartItems.reduce((total, item) => total + item.quantity, 0);

    const handleAddToCart = (product) => {
        dispatch(addItem(product));  // Dispatch the addItem action to add the item to the cart
    };
