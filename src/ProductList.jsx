    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <text id="cartTotalNumber" x="130" y="130" font-size="100" fill="black" text-anchor="middle" alignment-baseline="middle">{totalItems}</text></svg></h1></a></div>
            </div>
        </div>
        {!showCart? (
                        ...
                        {category.plants.map((plant, plantIndex) => (
                            <div className='product-card' key={plantIndex}>
                                ...
                                <button className='product-button'
                                    style={{background : addedToCart[plant.name] ? "red" : "#4CAF50"}}
