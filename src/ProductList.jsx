...
function ProductList() {
    ...
    const numberOfItemInCart = useSelector(state=> state.cart.items).length;
    ...
    const handleRemoveFromCart = (plant) => {
        setAddedToCart({...addedToCart, [plant.name]: false})
    }
...
const handlePlantsClick = (e) => {
   ...
   const handleContinueShopping = (e) => {
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                    <h1 className='cart'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68"
                            ...
                            <text x="128" y="120" text-anchor="middle" font-size="55" fill="white"
            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((plants, index) => (
                        <div key={index}>
                            <h1>
                                <div className='plant_heading'>{plants.category}</div>
                            </h1>
    ...
    <CartItem onContinueShopping={handleContinueShopping} deleteFromCartCallback={handleRemoveFromCart}/>
)}
    </div>
    );
}
