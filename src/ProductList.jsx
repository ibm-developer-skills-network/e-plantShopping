...
function ProductList() {
   ...
   const handleAddToCart = (plant) => { 
    setAddedToCart((prev) => ({ 
        ...prev, 
        [plant.name]: true // Track that the plant has been added
    })); 
    console.log(`${plant.name} added to cart`); 
    // Implement the logic for adding the plant to the cart
    dispatch(addItem(plant)); // Add plant to the cart using redux
};
  return ( 
      <div> 
