...
import { addItem } from './CartSlice'; // Make sure to import the addItem function from CartSlice

function ProductList() {
    const [showCart, setShowCart] = useState(false); 
    const [addedToCart, setAddedToCart] = useState({});
    const dispatch = useDispatch(); // Initialize the dispatch for CartSlice
    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Calendula", image: "https://cdn.pixabay.com/photo/2019/07/15/18/28/flowers-4340127_1280.jpg", description: "Heals minor skin injuries and burns.", cost: "$17" }
            ]
        }
    ];
