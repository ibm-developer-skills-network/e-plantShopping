...
import { selectTotalQuantity } from "./CartSlice"; // Import the selector



// Funcion ProductList muestra los productos
        ...
        <div className="tag">
          <div className="luxury">
            ...
            <a href="/" style={{ textDecoration: "none" }}>
              <div>
                <h3 style={{ color: "white" }}>e-Plant Jungle </h3>
                <i style={{ color: "white" }}>Believe in The Power of Plants</i>
              </div>
            </a>
          </div>
        </div>
