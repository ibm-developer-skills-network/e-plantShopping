...
import { removeItem, updateQuantity } from './CartSlice'; // Ensure CartSlice.js has these actions defined
import './CartItem.css';
...
const CartItem = () => {
 ...
 alert("Functionality to be added for future reference")
  ...
  const handleRemove = (item) => {
    dispatch(removeItem(item.name)); // Remove item by dispatching removeItem action
  };
